...
import imgTitleScreen from '../media/img/gui/title-screen.png';
import imgLevelCompletedScreen from '../media/img/gui/level-completed-screen.png';
import imgGameOverScreen from '../media/img/gui/game-over-screen.png';
